package dev.wookie.security.dto;

import dev.wookie.domain.Member;
import dev.wookie.domain.Role;
import dev.wookie.domain.Social;
...
public class OAuthAttributes {
    ...
    public Member toEntity(){
        return Member.builder().name(name).email(email).picture(picture).role(Role.USER).social(
            Social.valueOf(registrationId.toUpperCase())).build();
    }
}